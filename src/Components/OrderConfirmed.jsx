...
const TheOrder = location.state?.TheOrder;
const ETA = location.state?.ETA;
const [timeLeft, setTimeLeft] = useState(null); // Time left for the order to be ready
    ...
    if (ETA) {
        ...
        return (
            <div className={styles.orderConfirmed}>
                ...
                {timeLeft !== null ? (
                    <p className={styles.ETA}>ETA: {timeLeft} MIN</p>
                    ) : (
